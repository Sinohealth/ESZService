...
public class EncryptUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String en = encryptDes("8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92", key);
...
//						en, den));
		...
		System.out.println("data:"+data+"\r encode:"+en+"\rdecode: "+den+"\r deEn:"+En+
